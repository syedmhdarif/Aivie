  ...
  render() {
    return (
        ...
        <ScrollView >
          ...
          <Text style={{marginTop:'5%', marginLeft:'18%',position:'absolute'}}>Syed Arif</Text>
          ...
          <View style={{height:960}}>
            ...
            <TouchableOpacity >
            <LinearGradient colors={['#FFD200', '#F7971E']} style={styles.newproject}>
            <Image
            source={require('../images/newproject2.png')}
            style={{width:'10%', height:'27%', marginRight:'3%'}}
            resizeMode="stretch"/>
              <Text style={{fontSize:20, color:'white', fontFamily:'poppins-semi-bold'}}>New Project</Text>
            </LinearGradient>
            </TouchableOpacity>
            </View>

            <View style={{position:'absolute', marginTop:'90%', flexDirection:'column'}}>
              <View style={{flexDirection:'row',justifyContent:'center', marginLeft:'6%'}}>
              ...
              <View style={{flexDirection:'row', marginLeft: '5%',alignItems:'center', marginTop:'3%'}}>
                  ...
                  <TouchableOpacity style={{width:'20%', height:'30%', backgroundColor:'#F7971E', borderRadius:15, marginLeft:'13%', justifyContent:'center', alignItems:'center'}}>
